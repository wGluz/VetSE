...
public class enderecos_cadastrados extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent b = new Intent(enderecos_cadastrados.this, home.class);
            }
        });
        ...
        bt_cadastrar_endereco.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent b = new Intent(enderecos_cadastrados.this, cadastrar_endereco.class);
            }
        });
    }
}