...
public class forma_pagamento extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent b = new Intent(forma_pagamento.this, home.class);
            }
        });
        ...
        bt_cadastrar_cartao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent b = new Intent(forma_pagamento.this, cadastrar_cartao.class);
            }
        });
    }
}